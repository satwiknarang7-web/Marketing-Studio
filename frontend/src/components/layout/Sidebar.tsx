...
export function Sidebar() {
  ...
  return (
    <div
      className={cn(
        "flex h-screen flex-col studio-surface-sunken text-white transition-all duration-300 border-r border-border/60",
        collapsed ? "w-20" : "w-64"
      )}
    >
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-slate-400 hover:bg-muted/60 hover:text-white"
                )}
              >
      ...
      <div className="p-3 border-t border-border/60 space-y-2">
        {!collapsed && (
          <div className="p-3 rounded-xl bg-card border border-border flex items-center gap-2 text-xs text-slate-300">
            <Sparkles className="h-4 w-4 text-blue-400 flex-shrink-0" />
            <div className="flex-1 truncate">
              <p className="font-semibold text-white">Studio Engine</p>
        ...
        <button
          ...
          className="flex w-full items-center justify-center rounded-xl p-2 text-slate-400 hover:bg-muted/60 hover:text-white transition-colors"
        >
